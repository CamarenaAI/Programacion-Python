...
80 characters. Historically, this guideline developed because most computers could fit only 79 characters on a single line in a terminal window. 
Currently, people can fit much longer lines on their screens, but other reasons exist to adhere to the 79-character standard line length. Professional 
...
in your code as you’re learning, but be aware that people who are working collaboratively almost always follow the PEP 8 guidelines. Most editors 
...
readability of your code. The Python interpreter uses horizontal indentation to interpret the meaning of your code, but it disregards vertical 
spacing.
"""

# Other Style Guidelines
"""
PEP 8 has many additional styling recommendations, but most of the guidelines refer to more complex programs than what you’re writing at this point. 
